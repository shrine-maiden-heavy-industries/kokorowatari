...
from kokorowatari import __version__ as kokorowatari_version

ROOT_DIR = (Path(__file__).parent).parent

project   = 'Kokorowatari'
version   = kokorowatari_version
...
extlinks = {
	'torii-issue': ('https://github.com/shrine-maiden-heavy-industries/torii-hdl/issues/%s', 'torii/%s'),
	'torii-ila-issue': ('https://github.com/shrine-maiden-heavy-industries/torii-ila/issues/%s', 'torii-ila/%s'),
	'kokorowatari-issue': ('https://github.com/shrine-maiden-heavy-industries/kokorowatari/issues/%s', 'kokorowatari/%s'),
...
intersphinx_mapping = {
	...
	'torii_ila':  (f'https://torii-ila.shmdn.link/v{torii_ila_version}', None),
...
html_baseurl     = 'https://kokorowatari.shmdn.link/'
html_theme       = 'furo'
html_copy_source = False

html_theme_options = {
	'announcement': 'This documentation is a work in progress, and you can help us <a href="https://github.com/shrine-maiden-heavy-industries/kokorowatari/blob/main/CONTRIBUTING.md">improve it!</a>', # noqa: E501
	'light_css_variables': {
	...
	'source_repository': 'https://github.com/shrine-maiden-heavy-industries/kokorowatari/',
	'source_branch': 'main',
